...
import { Bn as markRaw, Ft as onMounted, Kn as ref, Ot as nextTick, U as computed, Ut as provide, Wn as reactive, gn as watch, jt as onBeforeUnmount, nt as defineComponent, p as render, pt as h$1, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-CJdF6Oq_.js";
...
var ce = (e, o) => {
	...
	const o = await Promise.all([
		import("/home/kouraan/Área de Trabalho/Uni/3ano/IPM/Outro/2.ª Fase/node_modules/leaflet/dist/images/marker-icon-2x.png"),
		import("/home/kouraan/Área de Trabalho/Uni/3ano/IPM/Outro/2.ª Fase/node_modules/leaflet/dist/images/marker-icon.png"),
		import("/home/kouraan/Área de Trabalho/Uni/3ano/IPM/Outro/2.ª Fase/node_modules/leaflet/dist/images/marker-shadow.png")
	]);
	...
	*/
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { circle: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { circleMarker: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
			t.value = markRaw(i(e.latLng, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { Control: i, DomEvent: u } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { featureGroup: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { geoJSON: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { GridLayer: u, DomUtil: d, Util: y } = r ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { DomEvent: N, divIcon: P, icon: B } = n ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { imageOverlay: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { layerGroup: a } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
...
var We = {
	...
	*/
	...
	setup(e, o) {
		...
		onMounted(async () => {
			e.useGlobalLeaflet && (b.L = b.L || await import("./leaflet-src-CQB6vOWY.js").then((m) => /* @__PURE__ */ __toESM(m.default)));
			const { map: P, CRS: B, Icon: I, latLngBounds: E, latLng: ue, stamp: $ } = e.useGlobalLeaflet ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
			try {
...
var $t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { marker: u, divIcon: d } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { polygon: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { polyline: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
			t.value = markRaw(i(e.latLngs, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { popup: u } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { rectangle: i, latLngBounds: u } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { tileLayer: a } = n ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { tooltip: i } = s ? b.L : await import("./leaflet-src.esm-BUyYdHUS.js");
